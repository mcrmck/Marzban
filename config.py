...
SQLALCHEMY_DATABASE_URL = config("SQLALCHEMY_DATABASE_URL", default="sqlite:///app/db/marzban.db")
...
MOCK_STRIPE_PAYMENT = config("MOCK_STRIPE_PAYMENT", default=True, cast=bool)
