...
const useClientPortalStore = create<ClientPortalState>()((set, get) => ({
    // Auth state
...
// Selectors
export const useIsAuthenticated = () => useClientPortalStore(state => state.isAuthenticated);
export const useIsLoadingAuth = () => useClientPortalStore(state => state.isLoadingAuth);
export const useAuthError = () => useClientPortalStore(state => state.error);
export const useLogin = () => useClientPortalStore(state => state.login);
export const useLogout = () => useClientPortalStore(state => state.logout);
export const useRegister = () => useClientPortalStore(state => state.register);
export const useInitializeAuth = () => useClientPortalStore(state => state.initializeAuth);

export { useClientPortalStore };