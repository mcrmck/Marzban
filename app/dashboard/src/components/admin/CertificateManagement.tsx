...
export const CertificateManagement: React.FC = () => {
  ...
  const fetchStatus = async () => {
    try {
      setLoading(true);
      const data = await fetch.get<CertificateStatus>('/certificates/status');
      setStatus(data);
    } catch (error) {
  ...
  const fetchCaInfo = async () => {
    try {
      const data = await fetch.get<CertificateInfo>('/certificates/ca');
      setCaInfo(data);
    } catch (error) {
  ...
  const regenerateCA = async () => {
    ...
    try {
      ...
      await fetch.post('/certificates/ca/regenerate');
  ...
  const rotateNodeCerts = async (nodeName: string) => {
    try {
      ...
      await fetch.post(`/certificates/node/${nodeName}/rotate`);
  ...
  const exportNodeCerts = async (nodeName: string) => {
    try {
      ...
      const data = await fetch.get(`/certificates/node/${nodeName}/export`);
