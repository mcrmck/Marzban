...
def charge_command(call: types.CallbackQuery):
    ...
    # Handle charging without templates
    # TODO: Implement direct charging functionality
    bot.answer_callback_query(call.id, "Template functionality has been removed. Please implement direct charging.", show_alert=True)
